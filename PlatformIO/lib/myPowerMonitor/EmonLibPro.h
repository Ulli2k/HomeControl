...
//--------------------------------------------------------------------------------------------------
#if defined(HAS_POWER_MONITOR_CT) //Ulli
	#include "EmonLibPro_config.h"
#else

	#define VOLTSCOUNT 0        // Number of V sensors installed, can be 0 or 1, multiple voltage sensors are not supported this time
	#define CURRENTCOUNT 3      // Number of CT sensors installed can be 1 to 3.
	...
	#define I1CAL 13.333            // Gain for CT1 calculated value is 20A:0.02A (for CT spirals) / 100 Ohms (for burden resistor) = 10
	#define I2CAL 13.333            // Gain for CT2 100:0.05 / 150 Ohm = 13,333
	#define I3CAL 13.333            // Gain for CT3
	...
	#define SUPPLY_VOLTS 3.306 //4.95     // used here because it's more accurate than the internal band-gap reference
