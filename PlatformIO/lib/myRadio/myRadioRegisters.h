...
//#define RF_BITRATEMSB_2667						0x2E  // Ulli HX2272 2667bps --> 375µs Pulse
//#define RF_BITRATELSB_2667						0xDF  // Ulli HX2272 2667bps --> 375µs Pulse
#define RF_BITRATEMSB_3125						0x28  // Ulli HX2272 3,125bps --> 320µs Pulse
#define RF_BITRATELSB_3125						0x00  // Ulli HX2272 3,125bps --> 320µs Pulse
#define RF_BITRATEMSB_5000						0x19  // Ulli FS20 5kbps --> 200µs Pulse
#define RF_BITRATELSB_5000						0x00  // Ulli FS20 5kbps --> 200µs Pulse
#define RF_BITRATEMSB_10000						0x0C  // Ulli HomeMatic 10kbps (9993bps)
#define RF_BITRATELSB_10000						0x80  // Ulli HomeMatic 10kbps (9993bps)

#define RF_BITRATEMSB_17240						0x07 	// Ulli ITPlus Bitrate	17.24 kbps
#define RF_BITRATELSB_17240						0x40 	// Ulli ITPlus Bitrate	17.24 kbps
...
#define RF_FDEVMSB_19043						0x01 // Ulli
#define RF_FDEVLSB_19043						0x38 // Ulli
...
#define RF_RXBW_DCCFREQ_010						0xE0//0x40  // Default
...
// RegAfcCtrl - Ulli
#define RF_AFCCTL_LOWBETA_ON						0x20
#define RF_AFCCTL_LOWBETA_OFF						0x00
...
// RegDioMapping1
/*
#define RF_DIOMAPPING1_DIO0_00	  				0x00  // --> Ulli Dio2 REceive Pin Int1
#define RF_DIOMAPPING1_DIO0_01		  			0x04
#define RF_DIOMAPPING1_DIO0_10			  		0x08
#define RF_DIOMAPPING1_DIO0_11				  	0x0C
*/
