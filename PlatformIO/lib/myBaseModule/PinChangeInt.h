...
#ifdef DEBUG
	PRINT_TO_SERIAL.print("addPin. pin given: "); PRINT_TO_SERIAL.print(arduinoPin, DEC);
	int addr = (int) p;
	PRINT_TO_SERIAL.print(" instance addr: "); PRINT_TO_SERIAL.println(addr, HEX);
	PRINT_TO_SERIAL.print("userFunc addr: "); PRINT_TO_SERIAL.println((int)p->PCintFunc, HEX);
#endif

	enable(p, userFunc, mode);
#ifdef DEBUG
	PRINT_TO_SERIAL.print("addPin. pin given: "); PRINT_TO_SERIAL.print(arduinoPin, DEC), PRINT_TO_SERIAL.print (" pin stored: ");
	int addr = (int) p;
	PRINT_TO_SERIAL.print(" instance addr: "); PRINT_TO_SERIAL.println(addr, HEX);
#endif
	return(1);
...
#ifdef DEBUG
	PRINT_TO_SERIAL.print("attachInterrupt- pin: "); PRINT_TO_SERIAL.println(arduinoPin, DEC);
#endif
