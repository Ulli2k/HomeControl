...
#	CPPFLAGS					+= -DRFM69_CMD_TUNNELING_DEFAULT_VALUE=false -DRFM69_CMD_TUNNELING_HOSTID_DEFAULT_VALUE=0
...
## ADC ##
#	CPPFLAGS				 +=	-DHAS_ADC=<Analog Pin w/o A> -DINFO_POLL_PRESCALER_ADC=1  #please define READVCC_CALIBRATION_CONST
# CPPFLAGS				 += -DHAS_ADC_6_CALIBRATION_CONST -DHAS_ADC_7_CALIBRATION_CONST

## ROLLO ##
#	CPPFLAGS				 += -DHAS_ROLLO -DROLLO_UP_DOWN_PIN=8 -DROLLO_POWER_PIN=7
	
## TRIGGER (Interrupts) ##
	CPPFLAGS				 += -DHAS_TRIGGER=2  #trigger 3:button(click,doubleclick,longclick) 2:pulse 1:High 0:Low
	#CPPFLAGS				 += -DTRIGGER_EVENT=MODULE_AVR_TRIGGER #Module Message like default: MODULE_AVR_TRIGGER or e.g. MODULE_ROLLO_EVENT
	CPPFLAGS				 += -DTRIGGER_PIN=INTOne #INTZero or INTOne or digitalPin
	CPPFLAGS				 += -DTRIGGER_DEBOUNCE_TIME=100 #[ms] Can just be used for Pulse,High,Low. !keeps AVR awake during debouncing time!

	CPPFLAGS				 += -DHAS_TRIGGER_1=2 #trigger 3:button(click,doubleclick,longclick) 2:pulse 1:High 0:Low
	#CPPFLAGS				 += -DTRIGGER_1_EVENT=MODULE_AVR_TRIGGER #Module Message like default: MODULE_AVR_TRIGGER or e.g. MODULE_ROLLO_EVENT	
	CPPFLAGS				 += -DTRIGGER_1_PIN=8 #INTZero or INTOne or digitalPin
	CPPFLAGS				 += -DTRIGGER_1_DEBOUNCE_TIME=1000 #[ms] Can just be used for Pulse,High,Low. !keeps AVR awake during debouncing time!
