...
do_upload:
		ifdef $(FORCE_FLASH_PORT)
			setBaud=`curl -s -w -XPOST "http://$(FLASH_HOSTNAME)/console/baud?rate=$(FLASH_BAUDRATE)"`
		endif
		...
		ifdef $(FORCE_FLASH_PORT)
			setBaud=`curl -s -w -XPOST "http://$(FLASH_HOSTNAME)/console/baud?rate=$(MONITOR_BAUDRATE)"`
		endif
